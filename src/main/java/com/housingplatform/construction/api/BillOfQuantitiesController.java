...
public class BillOfQuantitiesController {
    ...
    @GetMapping
    @Operation(summary = "List BoQs", description = "Retrieve all bills of quantities with optional filtering")
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get BoQ by ID", description = "Retrieve bill of quantities information by ID")
    ...
    public ResponseEntity<BillOfQuantitiesResponse> createBoQ(@Valid @RequestBody BillOfQuantitiesRequest boqRequest) {
