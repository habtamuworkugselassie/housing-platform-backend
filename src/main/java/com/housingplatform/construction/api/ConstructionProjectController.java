...
public class ConstructionProjectController {
  ...
  public ResponseEntity<ConstructionProjectResponse> createProject(
      @Valid @RequestBody ConstructionProjectRequest request) {
    UUID companyId =
        UserContext.getCurrentUserOrganizationId()
            .orElseThrow(
                () -> new IllegalStateException("User must be associated with an organization"));
  ...
  @Operation(
      ...
      description = "Retrieve construction project information by ID")
  ...
  @Operation(
      ...
      description = "Retrieve all construction projects for the current user's organization")
  public ResponseEntity<Page<ConstructionProjectResponse>> getProjects(
    ...
    Page<ConstructionProjectResponse> projects =
        projectService.getProjectsByCompany(companyId, status, pageable);
  ...
  @Operation(
      ...
      description = "Retrieve all construction projects for a specific property")
  public ResponseEntity<List<ConstructionProjectResponse>> getProjectsByProperty(
  ...
  @Operation(
      summary = "Get projects by building",
      description = "Retrieve all construction projects for a specific building")
  public ResponseEntity<List<ConstructionProjectResponse>> getProjectsByBuilding(
  ...
  @Operation(
      ...
      description = "Retrieve all construction projects managed by a specific user")
  public ResponseEntity<Page<ConstructionProjectResponse>> getProjectsByManager(
    ...
    Pageable pageable = PageRequest.of(page, size);
    Page<ConstructionProjectResponse> projects =
        projectService.getProjectsByManager(managerId, pageable);
    return ResponseEntity.ok(projects);
  }
  ...
  public ResponseEntity<ConstructionProjectResponse> updateProject(
      @PathVariable UUID id, @Valid @RequestBody ConstructionProjectRequest request) {
    UUID companyId =
        UserContext.getCurrentUserOrganizationId()
            .orElseThrow(
                () -> new IllegalStateException("User must be associated with an organization"));
  ...
  @Operation(
      ...
      description = "Update the status of a construction project")
  public ResponseEntity<ConstructionProjectResponse> updateProjectStatus(
      @PathVariable UUID id, @RequestParam ConstructionProject.ProjectStatus status) {
  ...
  @AuthActionScope("construction.projects.update")
  @Operation(
      summary = "Calculate project costs",
      description = "Recalculate total costs for a construction project")
