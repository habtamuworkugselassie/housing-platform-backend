...
public class SupplierController {
  ...
  @Operation(
      ...
      description = "Retrieve all approved supplier organizations")
  public ResponseEntity<List<OrganizationResponse>> getAllSuppliers(
      @RequestParam(required = false) String status) {
    String filterStatus = status != null ? status : "APPROVED";
    List<OrganizationResponse> suppliers =
        organizationService.getAllOrganizations("SUPPLIER", filterStatus, null);
  ...
  @Operation(
      ...
      description = "Retrieve supplier organization information by ID")
  ...
  @Operation(
      summary = "Get my supplier organization",
      description = "Get the current user's supplier organization")
  ...
  @Operation(
      ...
      description = "Retrieve all materials offered by a supplier")
  public ResponseEntity<Page<MaterialResponse>> getSupplierMaterials(
    ...
    Page<MaterialResponse> materials =
        materialService.getAllMaterials(supplierId, category, pageable);
    return ResponseEntity.ok(materials);
  }

  @GetMapping("/{supplierId}/materials/categories")
  @Operation(
      summary = "Get supplier material categories",
      description = "Retrieve all unique material categories offered by a supplier")
  ...
  @Operation(
      ...
      description = "Search suppliers by name, city, or other criteria")
  public ResponseEntity<List<OrganizationResponse>> searchSuppliers(
      @RequestParam(required = false) String name,
      @RequestParam(required = false) String city,
      @RequestParam(required = false) String country) {
    List<OrganizationResponse> allSuppliers =
        organizationService.getAllOrganizations("SUPPLIER", "APPROVED", null);

    // Filter by criteria
    List<OrganizationResponse> filtered =
        allSuppliers.stream()
            .filter(
                supplier -> {
                  ...
                  if (name != null && !name.isEmpty()) {
                    matches =
                        matches && supplier.getName().toLowerCase().contains(name.toLowerCase());
                  }
