...
public class MaterialInventoryController {
  ...
  @Operation(
      ...
      description = "Create a new material inventory entry")
  public ResponseEntity<MaterialInventoryResponse> createInventory(
  ...
  @Operation(
      ...
      description = "Retrieve material inventory information by ID")
  ...
  @Operation(
      ...
      description = "Retrieve all inventory entries for a specific material")
  public ResponseEntity<List<MaterialInventoryResponse>> getInventoryByMaterial(
  ...
  @Operation(
      summary = "Get inventory by project",
      description = "Retrieve all inventory entries for a specific project")
  public ResponseEntity<List<MaterialInventoryResponse>> getInventoryByProject(
  ...
  @Operation(
      summary = "Get inventory by material and project",
      description = "Retrieve inventory entry for a specific material and project")
  public ResponseEntity<MaterialInventoryResponse> getInventoryByMaterialAndProject(
      @PathVariable UUID materialId, @PathVariable UUID projectId) {
    MaterialInventoryResponse inventory =
        inventoryService.getInventoryByMaterialAndProject(materialId, projectId);
    return ResponseEntity.ok(inventory);
  }
  ...
  @Operation(
      ...
      description = "Retrieve all inventory items that are below minimum stock level")
  ...
  @Operation(
      ...
      description = "Retrieve inventory entries filtered by status")
  public ResponseEntity<Page<MaterialInventoryResponse>> getInventoryByStatus(
    ...
    Page<MaterialInventoryResponse> inventory =
  ...
  public ResponseEntity<MaterialInventoryResponse> updateInventory(
      @PathVariable UUID id, @Valid @RequestBody MaterialInventoryRequest request) {
  ...
  public ResponseEntity<MaterialInventoryResponse> adjustInventory(
    ...
    MaterialInventoryResponse updated =
  ...
  @Operation(
      ...
      description = "Reserve inventory quantity for future use")
  public ResponseEntity<MaterialInventoryResponse> reserveInventory(
      @PathVariable UUID id, @RequestParam java.math.BigDecimal quantity) {
  ...
  @Operation(
      ...
      description = "Delete a material inventory entry (only if quantity is zero)")
