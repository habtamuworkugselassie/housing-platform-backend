...
public class ConstructionPhaseController {
    ...
    @Operation(summary = "Create phase", description = "Create a new construction phase for a project")
    ...
    @GetMapping
    @Operation(summary = "List phases", description = "Retrieve all phases for a construction project")
    ...
    @GetMapping("/{phaseId}")
    @Operation(summary = "Get phase by ID", description = "Retrieve construction phase information by ID")
    ...
    @AuthActionScope("construction.phases.update")
    @Operation(summary = "Update phase status", description = "Update the status of a construction phase")
    ...
    @AuthActionScope("construction.phases.update")
    @Operation(summary = "Update phase completion", description = "Update the completion percentage of a construction phase")
    public ResponseEntity<ConstructionPhaseResponse> updatePhaseCompletion(
            @PathVariable UUID projectId,
            @PathVariable UUID phaseId,
            @RequestParam Integer completionPercentage) {
        ConstructionPhaseResponse updated = phaseService.updatePhaseCompletion(phaseId, completionPercentage);
        return ResponseEntity.ok(updated);
    }
    ...
    public ResponseEntity<Void> reorderPhases(
            @PathVariable UUID projectId,
            @RequestBody List<UUID> phaseIdsInOrder) {
