...
public class MaterialController {
  ...
  @Operation(
      ...
      description = "Retrieve all materials with optional filtering")
  ...
  @Operation(
      ...
      description = "Create a new material listing (supplier only)")
  ...
  @Operation(
      ...
      description = "Update material information (supplier only)")
  public ResponseEntity<MaterialResponse> updateMaterial(
      @PathVariable UUID id, @Valid @RequestBody MaterialRequest materialRequest) {
    UUID supplierId = UserContext.getCurrentUserId();
