...
public class MaterialOrderController {
  ...
  @Operation(
      ...
      description = "Retrieve material order by order number")
  public ResponseEntity<MaterialOrderResponse> getOrderByOrderNumber(
  ...
  @Operation(
      summary = "List orders",
      description = "Retrieve material orders with optional filtering")
  ...
  public ResponseEntity<MaterialOrderResponse> updateOrderStatus(
      @PathVariable UUID id, @RequestParam MaterialOrder.OrderStatus status) {
  ...
  @Operation(
      ...
      description = "Record delivery date for a material order")
  ...
  @AuthActionScope("construction.orders.update")
  @Operation(
      summary = "Receive order items",
      description = "Record received quantity for order items")
  public ResponseEntity<MaterialOrderResponse> receiveOrderItems(
      @PathVariable UUID orderId,
      @PathVariable UUID itemId,
      @RequestParam java.math.BigDecimal receivedQuantity) {
    MaterialOrderResponse updated =
        orderService.receiveOrderItems(orderId, itemId, receivedQuantity);
    return ResponseEntity.ok(updated);
  }
  ...
  @Operation(
      ...
      description = "Delete a material order (only draft orders can be deleted)")
