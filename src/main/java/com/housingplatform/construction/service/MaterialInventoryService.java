...
public interface MaterialInventoryService {
    ...
    Page<MaterialInventoryResponse> getInventoryByStatus(MaterialInventory.InventoryStatus status, Pageable pageable);
    MaterialInventoryResponse updateInventory(UUID id, MaterialInventoryRequest request);
    MaterialInventoryResponse adjustInventory(UUID id, java.math.BigDecimal quantityChange, String reason);
