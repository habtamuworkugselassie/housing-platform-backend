...
public interface ConstructionProjectService {
    ...
    Page<ConstructionProjectResponse> getProjectsByCompany(UUID companyId, ConstructionProject.ProjectStatus status, Pageable pageable);
    ...
    ConstructionProjectResponse updateProject(UUID companyId, UUID projectId, ConstructionProjectRequest request);
    ConstructionProjectResponse updateProjectStatus(UUID projectId, ConstructionProject.ProjectStatus status);
