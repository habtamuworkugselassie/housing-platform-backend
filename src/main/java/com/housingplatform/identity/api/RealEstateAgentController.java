...
public class RealEstateAgentController {
  ...
  @Operation(
      ...
      description = "Register the current user as a real estate agent linked to a company")
  ...
  @Operation(
      ...
      description = "Get the current user's agent profile")
  ...
  @Operation(
      ...
      description = "Get all agents for a specific organization")
  public ResponseEntity<List<AgentResponse>> getAgentsByOrganization(
  ...
  @Operation(
      summary = "Register another user as agent",
      description =
          "Super agents can register other REALTOR users as agents for their organization")
  public ResponseEntity<AgentResponse> registerAgentForUser(
      @PathVariable UUID userId, @Valid @RequestBody AgentRegistrationRequest request) {
    AgentResponse agent = agentService.registerAgent(userId, request);
    return ResponseEntity.status(HttpStatus.CREATED).body(agent);
  }
  ...
  @Operation(
      ...
      description =
          "Super agents can create a new user account and register them as an agent for their organization")
  ...
  @Operation(
      ...
      description = "Super agents can update agent details in their organization")
  ...
  public ResponseEntity<AgentResponse> updateAgentStatus(
      @PathVariable UUID id, @RequestParam RealEstateAgent.AgentStatus status) {
