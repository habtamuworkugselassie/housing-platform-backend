...
public interface OrganizationService {
  ...
  /**
   * Load organization without marketplace visibility checks (e.g. internal enrichment). Prefer
   * {@link #getOrganizationById(UUID)} for API responses.
   */
  ...
  /**
   * Evict caches that depend on organization visibility or listing (properties-by-org,
   * sponsorship).
   */
