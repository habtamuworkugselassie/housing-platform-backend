...
public interface LoanApplicationRepository extends JpaRepository<LoanApplication, UUID> {
  ...
  List<LoanApplication> findByBuyerIdAndStatus(
      UUID buyerId, LoanApplication.LoanApplicationStatus status);

  List<LoanApplication> findByBankIdAndStatus(
      UUID bankId, LoanApplication.LoanApplicationStatus status);
}
