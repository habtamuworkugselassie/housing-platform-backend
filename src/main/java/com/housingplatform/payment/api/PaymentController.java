...
public class PaymentController {
  ...
  public ResponseEntity<Page<PaymentResponse>> getAllPayments(
    ...
    Page<PaymentResponse> payments =
        paymentService.getAllPayments(loanApplicationId, orderId, status, pageable);
  ...
  @Operation(
      ...
      description = "Create a loan disbursement payment (banker only)")
  public ResponseEntity<PaymentResponse> disburseLoan(
      @Valid @RequestBody LoanDisbursementRequest disbursementRequest) {
