...
public class BuildingController {
    ...
    @Operation(summary = "List buildings", description = "Retrieve all buildings with optional filtering. Public access.")
    ...
    @GetMapping("/{id}")
    @AuthPolicyScope(AuthPolicyScope.Policy.UNSECURED)
    @Operation(summary = "Get building", description = "Retrieve building information by ID. Public access.")
    ...
    @Operation(summary = "Get company buildings", description = "Retrieve all buildings for a real estate company")
    public ResponseEntity<List<BuildingResponse>> getBuildingsByCompany(@PathVariable UUID companyId) {
    ...
    public ResponseEntity<BuildingResponse> updateBuilding(
            ...
            @Valid @RequestBody BuildingRequest buildingRequest) {
        BuildingResponse updated = buildingService.updateBuilding(companyId, buildingId, buildingRequest);
    ...
    @Operation(summary = "Delete building", description = "Delete a building (only if it has no units)")
    ...
    @GetMapping("/{id}/units")
    @AuthPolicyScope(AuthPolicyScope.Policy.UNSECURED)
    @Operation(summary = "Get building units", description = "Retrieve all properties/units in a building. Public access.")
    public ResponseEntity<List<com.housingplatform.property.dto.PropertyResponse>> getBuildingUnits(@PathVariable UUID id) {
        BuildingResponse building = buildingService.getBuildingById(id);
    ...
    @AuthPolicyScope(AuthPolicyScope.Policy.UNSECURED)
    @Operation(summary = "Get financing offers for building", description = "Retrieve all financing offers available for a specific building. Public access.")
    ...
    @GetMapping("/search")
    @AuthPolicyScope(AuthPolicyScope.Policy.UNSECURED)
    @Operation(summary = "Search buildings", description = "Search buildings by company name, location, or other criteria. Public access.")
    public ResponseEntity<List<BuildingResponse>> searchBuildings(
        ...
        List<BuildingResponse> buildings = buildingService.searchBuildings(companyName, city, state, country, name, limit);
        return ResponseEntity.ok(buildings);
    }
}
