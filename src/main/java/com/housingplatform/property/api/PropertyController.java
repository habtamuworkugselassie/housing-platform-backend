...
public class PropertyController {
    ...
    @Operation(summary = "List all properties", description = "Retrieve a list of all properties. Public access shows only AVAILABLE properties.")
    public ResponseEntity<Page<PropertyResponse>> getAllProperties(
        ...
        Page<PropertyResponse> properties = propertyService.getAllProperties(status, city, pageable, publicOnly);
        return ResponseEntity.ok(properties);
    }
    
    @GetMapping("/{id}")
    @AuthPolicyScope(AuthPolicyScope.Policy.UNSECURED)
    @Operation(summary = "Get property by ID", description = "Retrieve detailed information about a specific property. Public access.")
    ...
    @AuthPolicyScope(AuthPolicyScope.Policy.REALTOR_SECURED)
    @Operation(summary = "Get properties by agent", description = "Get all properties for a specific agent")
    ...
    @AuthPolicyScope(AuthPolicyScope.Policy.REALTOR_SECURED)
    @Operation(summary = "Get properties by organization", description = "Get all properties for a specific organization (super agents only)")
    public ResponseEntity<List<PropertyResponse>> getPropertiesByOrganization(@PathVariable UUID organizationId) {
    ...
    @AuthPolicyScope(AuthPolicyScope.Policy.UNSECURED)
    @Operation(summary = "Get financing offers for property", description = "Retrieve all financing offers available for a specific property")
    ...
    @GetMapping("/search")
    @AuthPolicyScope(AuthPolicyScope.Policy.UNSECURED)
    @Operation(summary = "Search properties", description = "Search properties by company name, location, or other criteria. Public access.")
